...
int main() {
  ...
  //
  // p_number = &number; // Now p_number points to address2, but address1 is
  // still
  //                     // in use by our program. But our program has lost
  //                     access
  //                     // to that memory location. Memory has beed leaked
